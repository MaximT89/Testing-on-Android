...
import com.secondworld.buenas.testingonandroid.data.testing_screen.local.data_storage.ResultQuestionsStorage
...
class TestingRepositoryImpl @Inject constructor(private val storage: ResultQuestionsStorage) : TestingRepository {
